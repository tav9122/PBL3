...
namespace PBL3
{
    public partial class FormQuanLiSanPham : Form
    {
        ...
        {
            dataGridView1.DataSource = BLLButtonQuanLiSanPham.Instance.GetSanPhams(dictionary.FirstOrDefault(d => d.Value == comboBoxKieuSapXep.Text).Key, textBoxTimKiem.Text);
        }
