...
namespace PBL3
{
    public partial class FormQuanLiLichLamViec : Form
    {
        ...
        {
            dataGridView1.DataSource = BLLButtonQuanLiLichLamViec.Instance.GetLichLamViecs(dictionary.FirstOrDefault(d => d.Value == comboBoxKieuSapXep.Text).Key, textBoxTimKiem.Text, ascendingSort);
        }
