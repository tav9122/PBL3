...
namespace PBL3
{
    public partial class FormQuanLiLoHang : Form
    {
        ...
        {
            dataGridView1.DataSource = BLLQuanLiLoHang.Instance.GetLoHangs(dictionary.FirstOrDefault(d => d.Value == comboBoxKieuSapXep.Text).Key, textBoxTimKiem.Text);
        }
        ...
        private void buttonXoa_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    BLLQuanLiLoHang.Instance.DeleteLoHang(row.Cells["MaLoHang"].Value.ToString());
                }
